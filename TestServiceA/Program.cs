...
builder.Services.AddMassTransit(configure =>
{
    ...
    configure.AddConsumer<TestARequestEventConsumer>();
    configure.AddConsumer<TestARollBackRequestMessageConsumer>();
    configure.UsingRabbitMq((ctx, cfg) =>
    {
        ...
        cfg.ReceiveEndpoint(EventQueueConsts.TestARequestEventQueue, e =>
        {
            e.ConfigureConsumer<TestARequestEventConsumer>(ctx);
        });
        cfg.ReceiveEndpoint(EventQueueConsts.TestARollBackRequestMessageQueue, e =>
        {
            e.ConfigureConsumer<TestARollBackRequestMessageConsumer>(ctx);
        });
